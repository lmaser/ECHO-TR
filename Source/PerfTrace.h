...
// ============================================================================
// PerfTrace.h — Lightweight per-block performance tracing for ECHO-TR
//
// Usage:
//   #define ECHOTR_PERF_TRACE 1   // enable tracing (0 = no overhead)
//
// In processBlock:
//   PERF_BLOCK_BEGIN();
//   ... your DSP ...
...
public:
    ...
    void enableDesktopAutoDump (const juce::String& filename = "echotr_perf_dump.csv")
    {
